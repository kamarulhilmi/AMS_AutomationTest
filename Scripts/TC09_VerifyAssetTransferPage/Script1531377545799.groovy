...
WebUI.click(findTestObject('Nav_OR/Page_Asset Management System/a_Request'))

WebUI.click(findTestObject('Nav_OR/Page_Asset Management System/a_ Asset Transfer'))

WebUI.verifyElementPresent(findTestObject('PageVerification_OR/Page_Asset Management System/h2_Asset Request'), 0)
