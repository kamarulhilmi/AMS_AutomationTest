...
WebUI.click(findTestObject('Nav_OR/Page_Asset Management System/a_ Permission Code'))

WebUI.verifyElementPresent(findTestObject('PageVerification_OR/Page_Asset Management System/h2_Permission'), 0)
