...
WebUI.click(findTestObject('Nav_OR/Page_Asset Management System/a_ List of Value'))

WebUI.verifyElementPresent(findTestObject('PageVerification_OR/Page_Asset Management System/h2_List Of Value'), 0)
