...
WebUI.click(findTestObject('Nav_OR/Page_Asset Management System/a_Reports'))

WebUI.click(findTestObject('Nav_OR/Page_Asset Management System/a_ Asset Transfer Summary'))

WebUI.verifyElementPresent(findTestObject('PageVerification_OR/Page_Asset Management System/h2_Asset Transfer Summary'), 
    0)
