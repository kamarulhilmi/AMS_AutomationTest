...
WebUI.click(findTestObject('Nav_OR/Page_Asset Management System/a_ User'))

WebUI.verifyElementPresent(findTestObject('PageVerification_OR/Page_Asset Management System/h2_User Management'), 0)
