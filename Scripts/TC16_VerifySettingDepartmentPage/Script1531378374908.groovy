...
WebUI.click(findTestObject('Nav_OR/Page_Asset Management System/a_ Department'))

WebUI.verifyElementPresent(findTestObject('PageVerification_OR/Page_Asset Management System/h2_Department'), 0)
