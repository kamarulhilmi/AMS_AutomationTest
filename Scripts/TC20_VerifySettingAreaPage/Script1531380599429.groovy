...
WebUI.click(findTestObject('Nav_OR/Page_Asset Management System/a_ Area'))

WebUI.verifyElementPresent(findTestObject('PageVerification_OR/Page_Asset Management System/h2_Area'), 0)
