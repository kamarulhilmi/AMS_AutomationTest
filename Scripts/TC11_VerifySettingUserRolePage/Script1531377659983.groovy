...
WebUI.click(findTestObject('Nav_OR/Page_Asset Management System/a_ User Role'))

WebUI.verifyElementPresent(findTestObject('PageVerification_OR/Page_Asset Management System/h2_User Role'), 0)
