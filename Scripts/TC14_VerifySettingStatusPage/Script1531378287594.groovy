...
WebUI.click(findTestObject('Nav_OR/Page_Asset Management System/a_ Status'))

WebUI.verifyElementPresent(findTestObject('PageVerification_OR/Page_Asset Management System/h2_Status'), 0)
