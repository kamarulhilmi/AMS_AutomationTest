...
WebUI.click(findTestObject('Nav_OR/Page_Asset Management System/a_ Asset Summary'))

WebUI.verifyElementPresent(findTestObject('PageVerification_OR/Page_Asset Management System/h2_Asset Summary'), 0)
