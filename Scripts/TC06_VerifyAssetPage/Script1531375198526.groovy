...
WebUI.click(findTestObject('Nav_OR/Page_Asset Management System/a_Asset'))

WebUI.verifyElementPresent(findTestObject('PageVerification_OR/Page_Asset Management System/h2_Asset'), 0)
