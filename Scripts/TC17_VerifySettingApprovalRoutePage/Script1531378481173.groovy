...
WebUI.click(findTestObject('Nav_OR/Page_Asset Management System/a_Setting'))

WebUI.click(findTestObject('Nav_OR/Page_Asset Management System/a_ Approval Route'))

WebUI.verifyElementPresent(findTestObject('PageVerification_OR/Page_Asset Management System/h2_Approval Route'), 0)
