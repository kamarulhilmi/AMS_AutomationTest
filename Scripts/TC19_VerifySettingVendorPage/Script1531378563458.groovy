...
WebUI.click(findTestObject('Nav_OR/Page_Asset Management System/a_ Vendor'))

WebUI.verifyElementPresent(findTestObject('PageVerification_OR/Page_Asset Management System/h2_Vendor'), 0)
